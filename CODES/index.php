...
<div class="container">
  ...
  <button type="button" id="query_button" class="btn btn-lg" data-toggle="modal" data-target="#query">WALLET</button>
  <!-- Modal -->
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">           
                    <form method="post" action="query.php" class="form" role="form">
                        ...
                        <div class="form-group">
                             <label class="sr-only" for="query">Enter Amount</label>
                             <textarea class="form-control" rows="5" cols="30" name="message" placeholder="Amount" required></textarea>
                        </div>
                        <div class="form-group">
