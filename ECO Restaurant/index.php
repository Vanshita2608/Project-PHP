                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="banner-text">
                                    ...
                                    <p>Welcome to Our India, where culinary excellence meets exceptional dining experiences!</br>

                                        At Our India, we are dedicated to delighting your taste buds with our delectable dishes crafted from the finest ingredients and inspired by global flavors. Whether you're craving a hearty meal with friends and family or seeking an intimate dining experience for a special occasion, we invite you to embark on a culinary journey with us.</br>Our online website is your gateway to a world of gastronomic delights. Explore our diverse menu featuring a tantalizing array of breakfast,lunch, dinner all meticulously prepared by our talented chefs to satisfy every palate. From savory classics to innovative creations, each dish is a celebration of flavor and creativity.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="sec-title text-center mb-5">
                                ...
                                <p>Since 2000 we have held the most favourite restraunt in the critics and users eyes.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="row g-xxl-5 bydefault_show" id="menu-dish">
                                ...
                                <div class="col-lg-4 col-sm-6 dish-box-wp lunch" data-cat="lunch">
                                    <div class="dish-box text-center">
                                        ...
                                        <div class="dish-title">
                                            <h3 class="h3-title">Paneer Noodles</h3>
                                            <p>100 calories</p>
                                        </div>
                                        <div class="dish-info">
                                            <ul>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7">
                            <div class="sec-text">
                                ...
                                <p>This is our restraunts most oldest dish discovered by our greatest chefs and has been in the history of best sellers since we have opened.</p>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-lg-1 order-2">
                            <div class="sec-text">
                                <h2 class="xxl-title">Chicken Pepperoni</h2>
                                <p>This dish is our latest addition to the menu as we take a new take on the old classic.</p>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4">
                                    <div class="call-now text-center">
                                        ...
                                        <a href="tel:+91-8866998866">+91-1234567890</a>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="table-title text-center">
                            ...
                            <div class="swiper-wrapper">
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(assets/images/chef/chef1.jpg);"
                                            class="team-img back-img">

                                        </div>
                                        <h3 class="h3-title">Sanjeev Kapoor</h3>
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(assets/images/chef/chef2.jpg);"
                                            class="team-img back-img">

                                        </div>
                                        <h3 class="h3-title">Vikas Khanna</h3>
                                        <div class="social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#"><i class="uil uil-facebook-f"></i></a>
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(assets/images/chef/chef3.jpg);"
                                            class="team-img back-img">

                                        </div>
                                        <h3 class="h3-title">Ranveer Brar</h3>
                                        <div class="social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#"><i class="uil uil-facebook-f"></i></a>
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(assets/images/chef/chef4.jpg);"
                                            class="team-img back-img">

                                        </div>
                                        <h3 class="h3-title">Vineet Bhatia</h3>
                                        <div class="social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#"><i class="uil uil-facebook-f"></i></a>
                                ...
                                <div class="col-lg-4 swiper-slide">
                                    <div class="team-box text-center">
                                        <div style="background-image: url(assets/images/chef/chef5.jpg);"
                                            class="team-img back-img">

                                        </div>
                                        <h3 class="h3-title">Anjum Anand
                                        </h3>
                                        <div class="social-icon">
                                            <ul>
                                                <li>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="testimonials-box">
                                            ...
                                            <div class="testimonials-box-text">
                                                ...
                                                <p>"A Culinary Journey":
                                                    "Dining at Our India is more than just a meal – it's a culinary journey.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="testimonials-box">
                                            ...
                                            <div class="testimonials-box-text">
                                                ...
                                                <p>
                                                    "I stumbled upon Our India during a stroll, and I'm so glad I did! This place is an absolute gem.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="testimonials-box">
                                            ...
                                            <div class="testimonials-box-text">
                                                ...
                                                <p>"Dining at Our India is more than just a meal – it's a culinary journey.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="testimonials-box">
                                            ...
                                            <div class="testimonials-box-text">
                                                ...
                                                <p>"My dining experience at [Restaurant Name] was nothing short of exceptional.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="faq-row">
                            <div class="faq-box">
                                ...
                                <p>"Our restaurant's opening hours are 09:00 - 22:00. We welcome you to join us during our operating hours for a delightful dining experience. If you have any further questions or would like to make a reservation, please feel free to contact us."</p>
                            </div>
                            <div class="faq-box">
                                <h4 class="h4-title">When do i get my refund?</h4>
                                <p>"Thank you for reaching out. We apologize for any inconvenience caused. We aim to process refunds as quickly as possible. Typically, refunds are issued within 3-5 business days once the request has been processed.</p>
                            </div>
                            <div class="faq-box">
                                <h4 class="h4-title">How long it will take food to arrive?</h4>
                                <p>Our current estimated wait time for food preparation is approximately 15-20mins, but please keep in mind that this can vary based on the volume of orders and kitchen capacity at the moment.We appreciate your patience and understanding.  </p>
                            </div>
                            <div class="faq-box">
                                <h4 class="h4-title">Does your restaurant has both veg and non veg?</h4>
                                <p>"Yes, our restaurant offers a diverse menu that caters to both vegetarians and non-vegetarians. We take pride in providing a wide range of options to suit all dietary preferences and tastes. </p>
                            </div>
                            <div class="faq-box">
                                <h4 class="h4-title">What is cost of food delivery?</h4>
                                <p>At Our India, the cost of food delivery may vary depending on factors such as distance, order size, and the delivery service utilized.To provide you with accurate information regarding the cost of food delivery for your specific order, we recommend contacting our restaurant directly.  </p>
                            </div>
                            <div class="faq-box">
                                <h4 class="h4-title">What type of memberships do your offer?</h4>
                                <p>The memberships that Our India offers are as follows:

                                    1.Frequent Diners<br/>
                                    2.VIP Guests<br/>
                                    3.Special Events<br/>
                                    4.Community Partners<br/>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-text">
                                            ...
                                            <p>Chai, Coffee, Milkshake, Lemonade</p>
                                    ...
                                    <div class="newsletter-box text-center back-img white-text"
                                        ...
                                        <div class="sec-wp">
                                            <div class="newsletter-box-text">
                                                <h2 class="h2-title">Enter Your Mail For Receipt</h2>
                                            </div>
                                            <form action="#" class="newsletter-form">
                                                <input type="email" class="form-input"
                                                    placeholder="Email" required>
                                                    <a id="return-btn" onclick="btnClick()">Send Receipt</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="footer-info">
                                        ...
                                        <p>Hope we can provided you good service, and you enjoyeddd                                        </p>
                                        <div class="social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <div class="copyright-text">
                                    <p>Copyright &copy; 2024 <span class="name">~KVM~</span>All Rights Reserved.
                                    </p>
                                </div>
                            </div>
                        </div>
